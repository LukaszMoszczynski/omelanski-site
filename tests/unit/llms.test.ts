...
describe('buildLlmsFullTxt', () => {
  ...
  it('contains all content sections', () => {
    for (const s of ['Doświadczenie i kontakt z mieszkańcami', 'Obsługa rachunkowo-księgowa', 'Ustawa Prawo budowlane', 'Okres przechowywania', 'Pogotowie gazowe: 992', 'biuro@omelanski.com', 'E-kartoteka']) {
